      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-app p-7 shadow-app border-[1.5px] border-app-border">
          ...
          <div className="flex gap-2 flex-wrap mb-[18px]">
            {chips.map(c => (
              <button key={c} className="px-3.5 py-1 rounded-full bg-green-pale text-green-deep text-[0.82rem] font-medium border-[1.5px] border-app-border cursor-pointer transition-all hover:bg-green-mid hover:text-white hover:border-green-mid font-sarabun">
                {c}
              </button>
            ))}
          </div>
          <div className="grid grid-cols-2 gap-3 mb-[18px]">
            <div>
              ...
              <input type="number" defaultValue={150} placeholder="100"
            ...
            <div>
              ...
              <select className="w-full px-3.5 py-2.5 border-[1.5px] border-app-border rounded-app-sm bg-app-bg text-app-text font-sarabun text-[0.95rem] outline-none focus:border-green-mid focus:bg-white cursor-pointer">
          ...
          <button onClick={() => showToast('✅ บันทึกมื้ออาหารสำเร็จ!')}
            className="w-full py-3 rounded-app-sm font-prompt font-semibold text-white text-[1rem] border-none cursor-pointer transition-all hover:opacity-90 hover:-translate-y-px mb-5"
            style={{ background: 'linear-gradient(135deg, #16a97a, #0891b2)' }}
          >
            💾 บันทึกมื้ออาหาร
          </button>
          <div className="p-3.5 bg-app-bg2 rounded-app-sm">
            <div className="text-[0.83rem] text-app-text3 mb-2.5 font-sarabun">แคลอรีวันนี้</div>
            <div className="flex items-center gap-3">
              <div className="flex-1 h-2 bg-app-border rounded-full">
                <div className="h-full rounded-full" style={{ width: '62%', background: 'linear-gradient(90deg,#16a97a,#67e8f9)' }} />
              </div>
              <span className="font-bold text-green-deep font-prompt text-sm">1,240 / 2,000</span>
            </div>
          </div>
        </div>
