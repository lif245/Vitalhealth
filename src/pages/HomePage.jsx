  ...
  return (
    <PageTransition>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-[18px] mb-8">
        {stats.map((s, i) => (
          <div key={i} className="bg-app-bg2 rounded-app p-6 shadow-app border-[1.5px] border-app-border text-center transition-transform duration-150 hover:-translate-y-0.5 hover:shadow-app-lg">
            <div className="text-green-mid flex justify-center mb-2.5">{s.icon}</div>
            <AnimatedCounter value={s.val} className="text-[2rem] font-bold text-green-deep font-prompt block" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {/* Calories Bar Chart */}
        <div className="bg-app-bg2 rounded-app p-6 shadow-app border-[1.5px] border-app-border">
          <h3 className="text-[1.05rem] font-semibold mb-4 font-prompt text-green-deep">แคลอรีที่เผาผลาญรายสัปดาห์</h3>
        ...
        {/* Weight Line Chart */}
        <div className="bg-app-bg2 rounded-app p-6 shadow-app border-[1.5px] border-app-border">
          <h3 className="text-[1.05rem] font-semibold mb-4 font-prompt text-green-deep">แนวโน้มน้ำหนัก</h3>
          <div className="h-[200px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={[
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
        {[
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6.5 6.5 11 11"/><path d="m21 21-1-1"/><path d="m3 3 1 1"/><path d="m18 22 .5-1.5"/><path d="M14 18l.5-1.5"/><path d="M18 14l.5-1.5"/><path d="m22 18-1.5.5"/><path d="m18 14-1.5.5"/><path d="m14 10-1.5.5"/><path d="M2 6l1.5-.5"/><path d="M6 10l1.5-.5"/><path d="M10 14l1.5-.5"/><path d="m6 2-.5 1.5"/><path d="m10 6-.5 1.5"/><path d="m14 10-.5 1.5"/></svg>, label: 'บันทึกออกกำลังกาย', action: () => setModalType('exercise') },
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v11"/><path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7"/></svg>, label: 'บันทึกมื้ออาหาร', action: () => setModalType('food') },
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>, label: 'บันทึกการนอน', action: () => setModalType('sleep') },
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>, label: 'ตั้งเป้าหมาย', action: () => navigate('/settings') },
        ].map((q, i) => (
          <button
            key={i}
            onClick={q.action}
